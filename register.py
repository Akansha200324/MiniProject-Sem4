...
class Register:
    def __init__(self, root):
        ...
        btn_login=Button(self.root,text="Sign In",command=self.login_window,font=("times new roman",20,"bold"),fg="white",bg="blue").place(x=280,y=580)
                        ...
                        if(j=="@gmail.com") and len(self.txt_email.get())>=12:
                            ...
                            if len(self.txt_password.get())>=8:
                                ...
                                if(l>=1 and u>=1 and d>=1 and p>=1):
                                    ...
                                    messagebox.showerror("Error","Password should have 8 characters ,upper case letter,lower case letter,numeric value and special character '@','&','#','!','_'",parent=self.root) 
                            else:
                                messagebox.showerror("Error","Password should have 8 characters ,atleast one upper case letter,lower tcase letter,numeric value and special character '@','&','#','!','_'",parent=self.root)
